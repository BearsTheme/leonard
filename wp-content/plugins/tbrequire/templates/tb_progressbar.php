<div class="tb-progress-wraper <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <div class="row tb-progress-body">
        <?php
            ...
            <div class="<?php echo esc_attr($item_class);?>">
                ...
                <?php endif;?>
                <div class="tb-progress progress<?php if($vertical){ echo ' vertical bottom'; } ?> <?php if($striped){echo ' progress-striped';}?>" 
