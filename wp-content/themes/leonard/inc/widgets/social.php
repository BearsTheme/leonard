...
class TB_Social_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            __('Social', 'leonard'), // Name
            array('description' => __('Social Widget', 'leonard'),) // Args
        );
    }
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('Social', 'leonard' ) : $instance['title'], $instance, $this->id_base);
        }
        ...
        if (!empty($title))
            ...
            echo "<ul class='tb-social ".$style.' '.$align."'>";
    ...
    function form( $instance ) {
         ...
         ?>
         <p><label for="<?php echo esc_url($this->get_field_id('title')); ?>"><?php _e( 'Title:', 'leonard' ); ?></label>
         <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" /></p>

         <p><label for="<?php echo esc_url($this->get_field_id('style')); ?>"><?php _e( 'Style:', 'leonard' ); ?></label>
         <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('style') ); ?>" name="<?php echo esc_attr( $this->get_field_name('style') ); ?>">
            <option value="default"<?php if( $style == 'default' ){ echo 'selected="selected"';} ?>><?php _e('Default', 'leonard'); ?></option>
            <option value="style-1"<?php if( $style == 'style-1' ){ echo 'selected="selected"';} ?>><?php _e('Square', 'leonard'); ?></option>
            <option value="style-2"<?php if( $style == 'style-2' ){ echo 'selected="selected"';} ?>><?php _e('Rounded Square', 'leonard'); ?></option>
            <option value="style-3"<?php if( $style == 'style-3' ){ echo 'selected="selected"';} ?>><?php _e('Circle', 'leonard'); ?></option>
            <option value="style-4"<?php if( $style == 'style-4' ){ echo 'selected="selected"';} ?>><?php _e('Box Style 1', 'leonard'); ?></option>
            <option value="style-7"<?php if( $style == 'style-7' ){ echo 'selected="selected"';} ?>><?php _e('Box Style 2', 'leonard'); ?></option>
            <option value="style-5"<?php if( $style == 'style-5' ){ echo 'selected="selected"';} ?>><?php _e('No List', 'leonard'); ?></option>
            <option value="style-6"<?php if( $style == 'style-6' ){ echo 'selected="selected"';} ?>><?php _e('Circle Border', 'leonard'); ?></option>
         </select>
         </p>

         <p><label for="<?php echo esc_url($this->get_field_id('align')); ?>"><?php _e( 'Content Align:', 'leonard' ); ?></label>
         <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('align') ); ?>" name="<?php echo esc_attr( $this->get_field_name('align') ); ?>">
            <option value="text-left"<?php if( $align == 'text-left' ){ echo 'selected="selected"';} ?>><?php _e('Left', 'leonard'); ?></option>
            <option value="text-center"<?php if( $align == 'text-center' ){ echo 'selected="selected"';} ?>><?php _e('Center', 'leonard'); ?></option>
            <option value="text-right"<?php if( $align == 'text-right' ){ echo 'selected="selected"';} ?>><?php _e('Right', 'leonard'); ?></option>
         </select>
         </p>

         <p><label for="<?php echo esc_url($this->get_field_id('icon_facebook')); ?>"><?php _e( 'Icon 1:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_facebook')); ?>"><?php _e( 'Link 1:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_rss')); ?>"><?php _e( 'Icon 2:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_rss')); ?>"><?php _e( 'Link 2:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_youtube')); ?>"><?php _e( 'Icon 3:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_youtube')); ?>"><?php _e( 'Link 3:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_twitter')); ?>"><?php _e( 'Icon 4:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_twitter')); ?>"><?php _e( 'Link 4:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_google')); ?>"><?php _e( 'Icon 5:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_google')); ?>"><?php _e( 'Link 5:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_skype')); ?>"><?php _e( 'Icon 6:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_skype')); ?>"><?php _e( 'Link 6:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_yahoo')); ?>"><?php _e( 'Icon 7:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_yahoo')); ?>"><?php _e( 'Link 7:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_dribbble')); ?>"><?php _e( 'Icon 8:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_dribbble')); ?>"><?php _e( 'Link 8:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_flickr')); ?>"><?php _e( 'Icon 9:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_flickr')); ?>"><?php _e( 'Link 9:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_linkedin')); ?>"><?php _e( 'Icon 10:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_linkedin')); ?>"><?php _e( 'Link 10:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_vimeo')); ?>"><?php _e( 'Icon 11:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_vimeo')); ?>"><?php _e( 'Link 11:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_pinterest')); ?>"><?php _e( 'Icon 12:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_pinterest')); ?>"><?php _e( 'Link 12:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_github')); ?>"><?php _e( 'Icon 13:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_github')); ?>"><?php _e( 'Link 13:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_instagram')); ?>"><?php _e( 'Icon 14:', 'leonard' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_instagram')); ?>"><?php _e( 'Link 14:', 'leonard' ); ?></label>
