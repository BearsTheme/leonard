jQuery(document).ready(function($) {
	...
	$(document).on("click","#btn_add_social",function(e) {
		...
		if(title == '' || link == '' || icon == ''){
			...
			$('.tb_no_item').remove();
			$('#the-list').append('<tr><td class="title">'+title+'</td><td class="link">'+link+'</td><td class="icon">'+icon+'</td><td><a title="Click to edit this item" href="javascript:void(0)" class="tb_social">Edit</a>|<a class="tb_social_remove" href="javascript:void(0)">Remove</a></td></tr>');
			savedata();
		}
	})
	$(document).on("click",".tb_social_remove",function(e) {
		removeItem(this);
		savedata(); 
	})
	$(document).on("click",".tb_social",function(e) {
