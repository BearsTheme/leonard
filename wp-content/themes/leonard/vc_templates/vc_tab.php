...
$output = $title = $tab_id = $tb_tab_bg_color = $tb_tab_border_color = '';
...
$output .= "\n\t\t\t" . '<div id="tab-'. (empty($tab_id) ? sanitize_title( $title ) : $tab_id) .'" class="'.$css_class.'" style="background-color: '.$tb_tab_bg_color.';border-color: '.$tb_tab_border_color.';">';
...
echo "<style type='text/css'>";
	echo "#tab-$tab_id .btn.btn-default.btn-white { 
		  background-color: $tb_tab_bg_color;}
		  #tab-$tab_id img {border-color: $tb_tab_border_color;}
    ";
echo "</style>";